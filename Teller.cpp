...
int main(int argc, char* argv[])
{
        ...
        for (size_t i = 0; i < num_trans; i++) t_vec.push_back(std::thread(teller_thread, &B, trans_arr[i]));
        ...
        for (size_t i = 0; i < num_trans; i++) t_vec2.push_back(std::thread(teller_threadsafe, &C, trans_arr[i]));
